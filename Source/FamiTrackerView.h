...
enum
{
	...
	// Pattern play row has changed
	WM_USER_MIDI_EVENT,
	// There is a new MIDI command	
...
private:
	...
	bool EditEffParamColumn(stChanNote& Note, int Value, int EffectIndex, bool& bStepDown, bool& bMoveRight,
	                        bool& bMoveLeft);
